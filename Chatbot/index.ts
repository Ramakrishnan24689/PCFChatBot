...
import { Chatbot, IPCFChatbotProps } from './Chatbot';

export class PCFChatbot implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	private theContainer: HTMLDivElement;
	private props: IPCFChatbotProps = {
		chatbotURL: "",
